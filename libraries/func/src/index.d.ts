export type Func<in Args extends readonly any[] = any[], out Return = any, in This = unknown> = (
    this: This,
    ...args: Args
) => Return;
export type AsyncFunc<in Args extends readonly any[] = any[], out Return = any, in This = unknown> = Func<
    Args,
...
export interface AbstractCtor<in Args extends readonly any[] = any[], out Instance = any> extends _AbstractCtor<
    Args,
    Instance
> {
    prototype: Instance;
