...
type _Func<Args extends readonly any[], Return>
    = (...args: Args) => Return
...
export interface _Ctor<Args extends readonly any[], Instance> {
...
type _ACtorFn<Args extends readonly any[], Instance>
    = abstract new (...args: Args) => Instance;
interface _ACtor<Args extends readonly any[], Instance> extends _ACtorFn<Args, Instance> {
    readonly prototype: Instance;
}
