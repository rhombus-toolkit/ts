...
export type PluralizeIrregular<T extends string> = Lowercase<T> extends keyof IrregularSingles
  ? IrregularSingles[Lowercase<T>]
  : never;

export type SingularizeIrregular<T extends string> = Lowercase<T> extends keyof IrregularPlurals
  ? IrregularPlurals[Lowercase<T>]
  : never;
