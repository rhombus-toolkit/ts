...
export type AsyncFunc<Args extends readonly any[] = any[], Return = any, Constraint = any> = Func<Args,
  Promise<Awaited<Return>>, Constraint>;
...
type _ACtorGAnyFn<Args extends readonly any[], Instance> = abstract new<T>(
  ...args: Replace<Args, T>
) => Replace<Instance, T>;
interface _ACtorGAny<Args extends readonly any[], Instance> extends _ACtorGAnyFn<Args, Instance> {
  readonly prototype: Replace<Instance, any>;
}
type _ACtorGConstrainedFn<Args extends readonly any[], Instance, Constraint> = abstract new<T extends Constraint>(
  ...args: Replace<Args, T>
) => Replace<Instance, T>;
interface _ACtorGConstrained<Args extends readonly any[], Instance, Constraint>
  extends _ACtorGConstrainedFn<Args, Instance, Constraint>
{
  readonly prototype: Replace<Instance, any>;
}
